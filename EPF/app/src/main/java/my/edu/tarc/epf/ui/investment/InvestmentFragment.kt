...
class InvestmentFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonCalculate.setOnClickListener {
            ...
            val excess: Float = balance - basic

            binding.textViewAmountInvestment.text = String.format("%.2f", excess * 0.3f)
        }
    ...
    //                                          specify generally ourselves by (...)->Unit
    class DateDialogFragment(val dateSetListener: (year: Int, month: Int, day: Int) -> Unit /*: OnDateSetListener*/) :
